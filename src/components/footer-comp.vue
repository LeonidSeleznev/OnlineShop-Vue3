<template>
  ...
  >
    ...
    <div class="socials flex flex-col">
      <h2 class="block text-white">Давайте общаться в соцсетях!</h2>
      <div class="socialIcons flex justify-center gap-x-2">
        <svg
          class="cursor-pointer transition hover:-translate-y-1 fill-white hover:fill-slate-400"
